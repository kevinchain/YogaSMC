...
void YogaSMC::addVSMCKey() {
    ...
    addECKeySp(KeyTB0T(0), "Battery", atomicSpKelvinKey);
    addECKeySp(KeyTB0T(1), "Battery Sensor 1", atomicSpKelvinKey);
    addECKeySp(KeyTB0T(2), "Battery Sensor 2", atomicSpKelvinKey);
